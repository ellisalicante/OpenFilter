...
config.lr = 0.1
config.output = "/home/bill/code/face_recognition/elasticface/models" # train model output folder
...
if config.dataset == "emoreIresNet":
    #for original LFW 
    #config.rec = "/home/bill/datasets/lfw/lfw_align_112"
    #config.rec = "/mnt/c/Users/Bill/Desktop/lfw_align_112_png_beauty_sequential_uniform/lfw_align_112_png_beauty01"
    config.rec = sys.argv[1]
